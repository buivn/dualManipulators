...
def rrbot_joint_positions_publisher():
    ...
    rospy.init_node('joint_positions_node_rrbot4', anonymous=True)

    #Initiate node for controlling joint1 and joint2 positions of robot 1.

    #Define publishers for each joint position controller commands.

    pub2_j1 = rospy.Publisher('/rrbot4/joint1_position_controller/command', Float64, queue_size=10)
    pub2_j2 = rospy.Publisher('/rrbot4/joint2_position_controller/command', Float64, queue_size=10)
